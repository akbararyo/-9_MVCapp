...
namespace PerpustakaanAppMVC.Model.context
{
    ...
    {
        //deklarasi private variable / field
        ...
        private OleDbConnection GetOpenConnection()
        {
            ...
            {
                //atur ulang lokasi database yang disesuaikan dengan lokasi database  perpustakaan anda
                string dbName = @"D:\18.11.2314\#9_MVCapp\project\PerpustakaanAppMVC\Database\DbPerpustakaan.mdb";

                //deklarasi variable connectionString, ref: https://www.connectionstrings.com/
